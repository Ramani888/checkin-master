  ...
  const handleSync = async () => {
    ...
    try {
      for (const item of pendingSync) {
        ...
        const isSuccess = await changeUserStatus(
          item.user_id,
          item.event_id,
              ...
              >
                <View style={styles.noEventsContainer}>
                  <View style={styles.videoContainer}>
                    ...
                    >
                      No Schedule Events at the moment
                    </Text>
                    <Text
                      style={{
                        fontSize: 16,
                    ...
                    >
                      It takes juts a minute to add a new event
                    </Text>
                    ...
                    <View style={styles.addButtonContainer}>
                      ...
                      >
                        <Text style={[styles.buttonText, { color: "#0179FF" }]}>
                          {strings.addEvent}
                        </Text>
                      </TouchableOpacity>
                      ...
                      <View style={{ width: "85%" }}>
                        ...
                        >
                          Need help in adding a new event? Watch the video and
                          lets do it
                        </Text>
                      </View>
