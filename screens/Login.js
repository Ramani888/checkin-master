...
import { StyleSheet, Text, View, TextInput, TouchableOpacity, Alert, Modal, ActivityIndicator, Image } from 'react-native';
...
const Login = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.loginBox}>
        ...
        <View style={styles.inputContainer}>
          ...
          <View  style={styles.input}>
            <Image source={require('../assets/tabler_user-filled.png')} style={styles.iconInput} />
          <TextInput
            style={{flex:1}}
        ...
        <View style={styles.inputContainer}>
          ...
          <View  style={styles.input}>
          <Image source={require('../assets/mdi_password.png')} style={styles.iconInput} />
          <TextInput
            style={{flex:1}}
      ...
      <TouchableOpacity style={styles.signupContainer} onPress={() => setIsSignUp(!isSignUp)}>
        <Text style={styles.signupLink}>
          {isSignUp ? 'Already have an account?' : "Don't have an account?"  } <Text style={styles.txtSignUp}>{isSignUp ? 'Sign In' : 'Register Now'}</Text>
        </Text>
      </TouchableOpacity>
      ...
      <Modal
        ...
        <View style={styles.modalBackground}>
          <View style={styles.activityIndicatorWrapper}>
            <ActivityIndicator animating={loading} size='large' color={colors.darkBgPrimary} />
            <Text style={styles.loadingText}>{isSignUp ? 'Signing up...' : 'Logging in...'}</Text>
          </View>
        </View>
      </Modal>
    </View>
